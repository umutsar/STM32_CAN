  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
		while(1) {
			...
			// Packet 1 Content
			Transmitted_Data[1] = 1;
			Transmitted_Data[2] = 2;
			Transmitted_Data[3] = 3;

			Transmitted_Data[4] = 4;
			Transmitted_Data[5] = 5;
			...
			Transmitted_Data[2] = 9;
			Transmitted_Data[3] = 10;

			Transmitted_Data[4] = 11;
			Transmitted_Data[5] = 12;
			Transmitted_Data[6] = 13;
			Transmitted_Data[7] = 14;
